...
<main class="container mx-auto py-8 px-4">
    <article class="prose lg:prose-xl">
        ...
        <img src="https://via.placeholder.com/800x400" alt="Placeholder Image" class="mb-4">
        ...
        <blockquote class="border-l-4 border-gray-600 italic pl-4 mt-4 mb-4">"Suspendisse potenti. Integer lacinia fringilla ligula, id venenatis dui lacinia id."</blockquote>
